...
@keyframes search-bar-container-load {
  0% {
    opacity: 0;
    transform: translateX(-100%);
    width: 50px;
...
@media screen and (max-width: 1000px) {
  ...
  .info-box-container .info-card {
      z-index: 2;
      position: relative;
  
      clip-path: circle(15px at 93% 17%);
